...
def _load_module():
    ...
    module_path = root / "auto_ocr_pipeline_v0.7_retuned.py"
    spec = importlib.util.spec_from_file_location("auto_ocr_pipeline_v0_7_retuned", module_path)
...
def main():
    ...
    out_csv = root / "v0_7_retuned_grouping_test_records_enhanced50.csv"
